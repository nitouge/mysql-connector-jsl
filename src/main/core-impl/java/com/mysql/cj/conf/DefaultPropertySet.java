...
public class DefaultPropertySet implements PropertySet, Serializable {
    ...
    public void initializeProperties(Properties props) {
        if (props != null) {
            ...
            System.out.println("\n>>> DefaultPropertySet initializeProperties..............");
            ...
            postInitialization();
            for (Map.Entry<Object, Object> objectObjectEntry : infoCopy.entrySet()) {
                System.out.println("\n\tDefaultPropertySet:" + objectObjectEntry.getKey() + " = " + objectObjectEntry.getValue());
            }
            System.out.println(">>> DefaultPropertySet initializeProperties end");
        }
    }
