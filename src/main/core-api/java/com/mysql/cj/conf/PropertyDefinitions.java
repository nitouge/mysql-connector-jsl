...
public class PropertyDefinitions {
    ...
    static {
        ...
        PropertyDefinition<?>[] pdefs = new PropertyDefinition<?>[] {
                ...
                // 自定义属性
                new BooleanPropertyDefinition(PropertyKey.forwardConsuming, DEFAULT_VALUE_FALSE, RUNTIME_MODIFIABLE,
                        Messages.getString("ConnectionProperties.forwardConsuming"), "8.0.33", CATEGORY_PERFORMANCE, Integer.MAX_VALUE),
