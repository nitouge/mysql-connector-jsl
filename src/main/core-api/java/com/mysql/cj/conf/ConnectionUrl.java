...
public abstract class ConnectionUrl implements DatabaseUrlContainer {
    ...
    protected void collectProperties(ConnectionUrlParser connStrParser, Properties info) {
        ...
        System.out.println("\n----------ConnectionUrl collect properties from connection string:");
        properties.forEach((key, value) -> System.out.println("\t" + key + ":" + value));
        System.out.println("------ConnectionUrl collect properties from connection string----------");
        ...
        System.out.println("\n------ConnectionUrl collect properties from additional sources:");
        properties.forEach((key, value) -> System.out.println("\t" + key + ":" + value));
        System.out.println("------ConnectionUrl collect properties from additional sources----------");
    }
