...
public class JdbcPropertySetImpl extends DefaultPropertySet implements JdbcPropertySet {
    ...
    public List<DriverPropertyInfo> exposeAsDriverPropertyInfo() throws SQLException {
        List<DriverPropertyInfo> driverPropertyInfoList = PropertyDefinitions.PROPERTY_KEY_TO_PROPERTY_DEFINITION.entrySet().stream()
        ...
        driverPropertyInfoList.forEach(p -> {
            System.out.println(">>> DriverPropertyInfo: " + p.name + " ::: " + p.value);
        });
