...
public class NativeProtocol extends AbstractProtocol<NativePacketPayload> implements Protocol<NativePacketPayload>, RuntimePropertyListener {
    ...
    private boolean isInternalQuery = false;

    public void markAsInternalQuery() {
        this.isInternalQuery = true;
    }

    public void clearInternalQuery() {
    ...
    public void init(Session sess, SocketConnection phConnection, PropertySet propSet, TransactionEventHandler trManager) {
        ...
        System.out.println("\n------------------------ NativeProtocol init.............. and propertySet: " + propertySet);
        ...
        System.out.println("------------------------ NativeProtocol init end ------------------------\n");
    }
    ...
    public final void send(Message packet, int packetLen) {
        try {
            ...
            this.packetSequence++;
            // MysqlPacketParser.parseTCPPayload(packet.getByteBuffer());
