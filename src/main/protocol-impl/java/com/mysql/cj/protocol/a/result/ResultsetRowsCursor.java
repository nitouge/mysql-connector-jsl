...
public class ResultsetRowsCursor extends AbstractResultsetRows implements ResultsetRows {
    ...
    public Row next() {
        ...
        System.out.println("ResultRowsCursor fetchedRows size: " + fetchedRows.size());
        Row row = this.fetchedRows.get(this.currentPositionInFetchedRows);
        System.out.println("ResultRowsCursor currentPositionInFetchedRows: " + this.currentPositionInFetchedRows);
    ...
    private void fetchMoreRows() {
        ...
        synchronized (this.owner.getSyncMutex()) {
            try {
                ...
                System.out.println("--------------- get cursor fetch size: " + numRowsToFetch);
