    ...
    public Row next() {
        try {
            if (!this.noMoreRows) {
                ...
                this.nextRow = null;
                this.isAfterEnd = true;
                System.out.println("ResultsetRowsStreaming noMoreRows currentPositionInFetchedRows: " + currentPositionInFetchedRows);
            }
            ...
            if (this.nextRow == null && !this.streamerClosed) {
                if (this.protocol.getServerSession().hasMoreResults()) {
                    ...
                    System.out.println("ResultsetRowsStreaming is closed currentPositionInFetchedRows: " + currentPositionInFetchedRows);
                    this.protocol.unsetStreamingData(this);
                    this.streamerClosed = true;
                }
            }
