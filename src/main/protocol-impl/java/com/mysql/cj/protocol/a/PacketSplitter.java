...
public class PacketSplitter {
    ...
    public boolean nextPacket() {
        ...
        // System.out.println("\nPacketSplitter nextPacket currentPacketLen: " + this.currentPacketLen);
        this.currentPacketLen = this.totalSize - this.offset;
        // System.out.println("\nPacketSplitter nextPacket currentPacketLen:" + currentPacketLen + ", totalSize: " + this.totalSize + ", offset: " + this.offset);
        if (this.currentPacketLen > NativeConstants.MAX_PACKET_SIZE) {
            System.err.println("\nPacketSplitter nextPacket currentPacketLen: " + this.currentPacketLen + ", MAX_PACKET_SIZE: " + NativeConstants.MAX_PACKET_SIZE);
